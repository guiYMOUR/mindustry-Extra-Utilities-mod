...
mh.trailWidth = 2;
mh.trailLength = 8;
mh.hitColor = mh.backColor = mh.trailColor = Items.phaseFabric.color;
mh.frontColor = Pal.thoriumAmmoFront;
...
mc.shrinkY = 0;
mc.drag = -0.01;
mc.hitColor = mc.backColor = Pal.copperAmmoBack;
mc.frontColor = Pal.copperAmmoFront;
...
mt.shrinkY = 0;
mt.drag = -0.01;
mt.hitColor = mt.backColor = Pal.thoriumAmmoBack;
mt.frontColor = Pal.thoriumAmmoFront;
...
mg.shrinkY = 0;
mg.drag = -0.01;
mg.hitColor = mg.backColor = Pal.graphiteAmmoBack;
mg.frontColor = Pal.graphiteAmmoFront;
