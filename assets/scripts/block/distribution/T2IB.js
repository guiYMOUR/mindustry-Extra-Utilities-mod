...
const invertedJunction = extend(Junction, "inverted-junction", {});
...
const TIJ = extend(Junction, "titanium-inverted-junction", {});
...
const T2LB = extend(LiquidExtendingBridge , "TLB",{});
