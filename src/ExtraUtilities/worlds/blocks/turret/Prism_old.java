...
public class Prism_old extends PowerTurret {
    //三棱镜光线聚集的强度
    ...
    public class PrismOldBuild extends PowerTurretBuild{
        ...
        protected void turnToTarget(float targetRot) {
            this.rotation = Angles.moveToward(this.rotation, targetRot, power.status * Prism_old.this.rotateSpeed * this.delta() * (bulletLife > 0 ? Prism_old.this.firingMoveFract : 1.0F));
        }
