...
const T2CSm = extendContent(GenericCrafter, "T2CSm", {});
T2CSm.hasItems = true;
...
T2CSm.drawer = new DrawLiquid(true);

T2CSm.consumes.liquid(Liquids.water, 0.05);
T2CSm.consumes.power(6);
T2CSm.consumes.items(ItemStack.with(
    Items.metaglass, 5,
    Items.titanium, 3,
));
